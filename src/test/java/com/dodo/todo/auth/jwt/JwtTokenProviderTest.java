...
class JwtTokenProviderTest {
    ...
    void rejectsTokenSignedWithDifferentKey() {
        JwtTokenProvider issuer = new JwtTokenProvider(jwtPropertiesWithSecret("secret-key-aaaaaaaaaaaaaaaaaaaaa"));
        JwtTokenProvider verifier = new JwtTokenProvider(jwtPropertiesWithSecret("secret-key-bbbbbbbbbbbbbbbbbbbbb"));
        ...
        assertThat(verifier.isValidToken(token)).isFalse();
    }

    private JwtProperties jwtPropertiesWithSecret(String secret) {
        JwtProperties props = new JwtProperties();
        props.setSecret(secret);
        props.setAccessTokenExpirationSeconds(604800L);
        return props;
    }
